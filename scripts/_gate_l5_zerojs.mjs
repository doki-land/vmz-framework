/**
 * L5 EventEntry zero-framework JS shell gate.
...
function fail(msg) {
    console.error(`L5-ZEROJS GATE FAIL: ${msg}`);
    process.exit(1);
}

console.log('L5-zerojs: build event-shell…');
...
console.log('L5-zerojs: compile manifest…');
...
try {
    ...
    console.log('L5-ZEROJS GATE PASS');
