/**
 * I3 locale router / PageMeta gate:
...
function fail(msg) {
    console.error(`I3 GATE FAIL: ${msg}`);
    process.exit(1);
}
...
console.log('I3: protocol freezes router/meta schemas…');
...
console.log('I3: prefix+include realization…');
...
console.log('I3: prefix+omit canonical / redirect / hreflang…');
...
console.log('I3: Link retains locale; reject hardcoded path…');
...
console.log('I3: locale-aware cache key…');
...
console.log('I3: LocaleTransition commits route + PageMeta…');
...
console.log('I3: route collision diagnosed…');
...
console.log('I3: CLI router-check on fixture…');
