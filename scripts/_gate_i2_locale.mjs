...
function fail(msg) {
    console.error(`I2 GATE FAIL: ${msg}`);
    process.exit(1);
}
...
console.log('I2: protocol freezes runtime schemas…');
...
console.log('I2: negotiateLocale priority…');
...
console.log('I2: FormatterContext digest + incompleteness…');
...
console.log('I2: SSR/client parity…');
const texts = {
...
console.log('I2: whole-message fallback…');
...
console.log('I2: atomic LocaleTransition…');
...
console.log('I2: CLI runtime-check on fixture…');
