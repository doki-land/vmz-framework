/**
 * L5 mixed idle+event fine packaging gate.
...
function fail(msg) {
    console.error(`L5-MIXED-PACK GATE FAIL: ${msg}`);
    process.exit(1);
}

console.log('L5-mixed-pack: build island…');
...
try {
    ...
    console.log('L5-MIXED-PACK GATE PASS');
