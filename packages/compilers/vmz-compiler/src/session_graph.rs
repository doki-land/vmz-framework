//! In-memory session graph index (N4.3).
//!
//! Long-lived Workspace keeps a coarse VPG/Deployment index across rebuilds.
//! Full incremental semantic VPG (doc 13 A/C) remains later — this closes the
...
impl SessionGraph {
    ...
    pub fn to_json(&self) -> String {
        ...
        // Pretty enough for gates that substring-match; keep stable key order via json! macro.
