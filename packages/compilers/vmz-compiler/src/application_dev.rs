//! Dev / Test / Deploy composition — `规划设计/vmz/22` M5.
//!
...
/// Prove M5 Dev/Test/Deploy contracts for a host workspace.
...
mod tests {
  ...
  mounts: [
    ...
    { application: 'beta', routeBase: '/apps/beta' },
        ...
        let rebuilt: Vec<_> =
            report.affected.units.iter().map(|u| u.application_id.as_str()).collect();
