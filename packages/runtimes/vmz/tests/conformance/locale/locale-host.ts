/**
 * locale multi-host delivery gate:
...
console.log(': protocol freezes delivery schemas…');
...
console.log(': web delivery slices reachable subset…');
...
console.log(': reject full client locale bundle…');
...
console.log(': Native pack signing / no JS…');
...
console.log(': Mini cross-package proof…');
...
console.log(': server ErrorCode envelope + format context…');
...
console.log(': cross-host MessageId invariant…');
...
console.log(': CLI delivery-check on fixture…');
