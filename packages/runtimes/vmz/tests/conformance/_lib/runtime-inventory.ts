...
const OWNER_SEED: Array<{
...
}> = [
    {
        ...
        owner: 'node-host',
        debtTarget: null,
        evidencePaths: ['packages/runtimes/vmz-runtime/src/browser/dom-core.ts', 'packages/runtimes/vmz-runtime/src/host/render-host.ts'],
    ...
    },
    {
        ...
        owner: 'node-host',
        debtTarget: null,
        evidencePaths: ['packages/runtimes/vmz-runtime/src/host/render-host.ts'],
    ...
    },
    {
        ...
        owner: 'node-host',
        debtTarget: null,
        evidencePaths: ['packages/runtimes/vmz-runtime/src/host/deployment-registry.ts'],
    ...
    },
    {
        ...
        debtTarget: null,
        evidencePaths: ['packages/runtimes/vmz-runtime/src/browser/dom-core.ts'],
        note: 'Thin reactive subscribe + patch dispatch only (0.2.0). Generated artifacts emit patch fns',
        distSignalId: 'trackPatch',
    },
    {
        id: 'untrackPatch',
        owner: 'browser-runtime',
        debtTarget: null,
        evidencePaths: ['packages/runtimes/vmz-runtime/src/browser/dom-core.ts'],
        note: 'Patch unsubscribe for branch/each teardown (0.2.0)',
        distSignalId: 'untrackPatch',
    },
    {
        ...
        evidencePaths: [
            ...
            'packages/runtimes/vmz-runtime/src/ssr/dom-ssr.ts',
            'packages/runtimes/vmz-runtime/src/faces/dom.browser.ts',
        ],
    ...
    },
    {
        ...
        debtTarget: null,
        evidencePaths: ['packages/runtimes/vmz/src/workspace/route-catalog-emit.ts', 'packages/runtimes/vmz-runtime/src/host/serve-host.ts'],
    ...
    },
    {
        ...
        debtTarget: null,
        evidencePaths: [
            'packages/runtimes/vmz/src/locale/locale-route-emit.ts',
            'packages/runtimes/vmz-runtime/src/host/localize-body-links.ts',
            'packages/runtimes/vmz/src/workspace/static-emit.ts',
            'packages/runtimes/vmz-runtime/src/host/serve-host.ts',
            'packages/runtimes/vmz-runtime/src/browser/client-nav.ts',
        ],
    ...
    },
    {
        ...
        owner: 'dev-host',
        debtTarget: null,
        evidencePaths: ['packages/runtimes/vmz-runtime/src/host/serve-host.ts'],
    ...
    },
    {
        ...
        debtTarget: null,
        evidencePaths: [
            'packages/runtimes/vmz/src/dev/dev-incremental.ts',
            'packages/runtimes/vmz/src/dev/dev-session.ts',
            'packages/runtimes/vmz-runtime/src/host/serve-host.ts',
        ],
